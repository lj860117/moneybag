...
const FUND_DETAILS = {
  ...
  '008114': { fullName:'天弘中证红利低波动100ETF联接A', type:'指数基金', company:'天弘基金', scale:'约19亿', fee:'管理费0.50%/年+托管费0.10%/年', founded:'2019-12-10', tracking:'中证红利低波动100指数', reason:'高股息+低波动双因子选股，每季度分红，像收房租。2022-2024连续三年同类排名优秀。', history:{y1:'+8.0%',y3:'+24.4%',y5:'+73.3%'}, risk:'中高风险(R4)', buyTip:'支付宝搜索008114→买入→选"定投"更佳', tags:['红利','低波动','高股息','季度分红'] },
