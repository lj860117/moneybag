...
class FundFilterResult:
    ...
    dimension_details: dict = field(default_factory=dict)  # 每个维度的详细结果
...
def _get_tracking_error(result: FundFilterResult, candidate_map: dict) -> float:
